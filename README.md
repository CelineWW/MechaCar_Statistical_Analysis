...
2.  What is the null hypothesis or alternative hypothesis?
  - H<sub>0</sub>(null hypothesis): If MechaCar has the same fuel efficiency as the competition vehicle, the **MPG** mean of MechaCar will be similiar to the **MPG** mean of the competition.
  - H<sub>a</sub>(alternative hypothesis): If MechaCar has better or worse fuel efficiency over the competition vehicle, the **MPG** mean of MechaCar will be statistically different from the **MPG** mean of the competition.
